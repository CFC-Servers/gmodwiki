...
function setDarkMode(value) {
    ...
    document.cookie = `darkMode=${value}${expires}; path=/; SameSite=Lax${location.protocol === 'https:' ? '; Secure' : ''}`;
}

function getDarkMode() {
    const nameEQ = 'darkMode=';
    ...
    return null; // Return null if the darkMode cookie has not been set
}
